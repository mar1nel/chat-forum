    ...
    return (
        <div className="card">
            <div className="likeCounter">
                <span><a className="plus" href="#" onClick={() => handleVote(1)}>+</a></span>
                {voteCount === 0 ? (
                    <span className="likes">{voteCount}</span> // eslint-disable-next-line
                ) : voteCount < 0 ? (
                    <span className="likes negative">{voteCount}</span>
                ) : (
                    <span className="likes positive">{voteCount}</span>
                )}
                <span><a className="minus" href="#" onClick={() => handleVote(-1)}>-</a></span>
            </div>
                ...
                <div className="postingDetails">
                    <div className="author">
                        <img className="authorPic" src="https://resizing.flixster.com/yLX51ssr5B7frEgwZCeV7N68gJw=/300x300/v2/https://flxt.tmsimg.com/assets/p3099992_e_h9_ab.jpg" alt=""/>
                            <span><a className="nickname" href="#">mar1nel</a></span>
                    </div>
